import { AboutContainer, FirstPart, Description } from './styles'
...
export const About = () => {
  return (
    <AboutContainer>
      <FirstPart>
        <img
          src="https://images.squarespace-cdn.com/content/v1/5ed00bab777fab6698681c63/1590692817409-QFO9HAUAGM475D4TVGF0/image-asset.jpeg"
          alt=""
        />
        <h2>Hecho con amor en Los Ángeles.</h2>
      </FirstPart>
